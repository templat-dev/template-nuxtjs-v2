...
<%_ struct.fields.forEach(function(field, index){ -%>
  <%_ if ((field.dataType === 'string' || field.dataType === 'array-string' || field.dataType === 'time' || field.dataType === 'array-time') && field.searchType === 1) { -%>
    <%_ searchConditions.push({name: field.name.lowerCamelName, type: 'string', range: false, required: field.searchValidateTags && field.searchValidateTags.some('required')}) -%>
  <%_ } -%>
  ...
  <%_ if ((field.dataType === 'bool' || field.dataType === 'array-bool') && field.searchType === 1) { -%>
    <%_ searchConditions.push({name: field.name.lowerCamelName, type: 'boolean', range: false, required: field.searchValidateTags && field.searchValidateTags.some('required')}) -%>
  <%_ } -%>
  <%_ if ((field.dataType === 'number' || field.dataType === 'array-number' || field.dataType === 'segment') && field.searchType === 1) { -%>
    <%_ searchConditions.push({name: field.name.lowerCamelName, type: 'number', range: false, required: field.searchValidateTags && field.searchValidateTags.some('required')}) -%>
  <%_ } -%>
  ...
  <%_ if ((field.dataType === 'number' || field.dataType === 'array-number') && 2 <= field.searchType &&  field.searchType <= 5) { -%>
    <%_ searchConditions.push({name: field.name.lowerCamelName, type: 'number', range: true, required: field.searchValidateTags && field.searchValidateTags.some('required')}) -%>
  <%_ } -%>
  <%_ if ((field.dataType === 'time' || field.dataType === 'array-time') && 2 <= field.searchType &&  field.searchType <= 5) { -%>
    <%_ searchConditions.push({name: field.name.lowerCamelName, type: 'string', range: true, required: field.searchValidateTags && field.searchValidateTags.some('required')}) -%>
  <%_ } -%>
<%_ }) -%>
<%_ } -%>
...
<%_ struct.fields.forEach(function (field, key) { -%>
  ...
  <%_ } -%>
  <%_ if (field.validateTags && field.validateTags.some('required')) { -%>
